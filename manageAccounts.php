...
<html>
	...
	<body>
		<div class = "container">
			...
			<li class = "active"><a href="manageAccounts.php">Manage Accounts</a></li>        
			</ul>
			<div class = "row">
				<div class = "col-xs-12">
					</br>
					<a href="editTenant.php" class="btn-lg btn-primary" role="button">Edit Tenant Info</a>
					<a href="createAccount.php" class="btn-lg btn-primary" role="button">Create Account</a>
					<a href="editAccount.php" class="btn-lg btn-primary" role="button">Edit Account</a>
				</div>
			</div>
