...
<html>
	<head>
		...
		<body>
			...
			<div class = "row">
				<div class = "col-xs-6">
					<button type = "button" class = "btn btn-primary" id = "BuildingAddAnother">Add Another</button> 
				</div>
				<div class = "col-xs-6">
					<button type = "button" class = "btn btn-primary" id = "BuildingSaveAndExit">Save and Exit</button> 
				</div>
			</div>
		</body>
</html>
