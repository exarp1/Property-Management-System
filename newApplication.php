...
<html>
	<head>
		<title>Application</title> 	<!-- Change Title to the page youre working on-->
	...
	print '
		<form action="newApplicationWriteout.php" method="post" id="form1">
		<div class = "container">
			<div class = "col-xs-12">
			...
			<div class = "row"> 
				...
				<div class = "col-xs-6">
					Primary EMail: <input type = "email" name = "PrimaryEmail" id = "PrimaryEmail">
				</div>
			</div>
			<div class = "row"> 
				<div class = "col-xs-6">
			...
			<div class = "row">
				...
				<div class = "col-xs-2">
					...
					<button type="submit" class="btn btn-primary" id ="SubmitApplication" form="form1">Submit Application</button>
				</div>
			</div>
		</div>
	</body>
