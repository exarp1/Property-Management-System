...
<html>
	<head>
		<title>Tenant Request Form</title> 	<!-- Change Title to the page you\'re working on-->
	...
	<body>
		<div class="container" id="TenantHome"> <!-- Unique name will help in the future if we just want to edit a certain area -->
			...
			<div class = "row">
					<input type = "text" name = "ComplaintInfo" id = "ComplaintInfo">
			</div>
			...
			<div class = "row">
				...
				<div class = "col-xs-4">
					<button type = "button" class = "btn btn-primary" name = "SubmitRequest" id = "SubmitRequest" onclick = "">Submit Request</button> 
				</div>
		</div>
	</body>
</html>
