...
<html>
	<head>
		<title>Notice of Rent Increase</title> 	<!-- Change Title to the page you\'re working on-->
		<meta charset="UTF-8">			<!-- Do not edit this -->
		<meta name="viewport" content="width=device-width, initial-scale=1"> <!-- Do not edit this -->
		<meta name="description" content="Notice of Rent Increase"> 	<!-- Change the contents of the content="" to a description of the page -->
	...
	<body>
		<div class="container" id="MoticeOfRentIncrease"> <!-- Unique name will help in the future if we just want to edit a certain area -->
			<div class = "row">
			...
			<div class = "row">
				<div class = "col-xs-12 text-right">
					Date: <input type = "date" name = "RentIncreaseDate" id = "RentIncreaseDate">
				</div>
			</div>
			<div class = "row">
			...
			<div class = "row">
				<div class = "col-xs-12 text-left">
					The new rent amount will be <input type = "text" name = "NewRentAmount" id = "NewRentAmount"> effective the first day of <input type = "date" name = "EffectiveDate" id = "EffectiveDate">
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12 text-left">
					As we sincerely appreciate you as a tenent, please feel free to contact us should you want to discuss this further.
				</div>
			</div>
		</div>
	</body>
