...
<html>
	<head>
		<title>90 Day Notice to Vacate The Property</title> 	<!-- Change Title to the page you\'re working on-->
		<meta charset="UTF-8">			<!-- Do not edit this -->
		<meta name="viewport" content="width=device-width, initial-scale=1"> <!-- Do not edit this -->
		<meta name="description" content="90 Day Notice to Vacate The Property"> 	<!-- Change the contents of the content="" to a description of the page -->
	...
	<body>
		<div class="container" id="90DayNoticeToVacateTheProperty"> <!-- Unique name will help in the future if we just want to edit a certain area -->
			<div class = "row">
				<div class = "col-xs-12 text-center">
					<h1> 90 Day Notice to Vacate The Property</h1>
				</div>
			</div>
			<div class = "row">
			...
			<div class = "row">
				<div class = "col-xs-12 text-center">
					This 90 day notice is required as per the Alberta Landlord and Tenancies Branch Regulations.
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-4">
