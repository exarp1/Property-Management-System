...
function echoDefaultHTML() {
	echo '
		...
		<html>
		<head>
		<title>Create Unit Work Orders</title>
		<meta charset="UTF-8">
	...
	echo '
		<div class="container">
		<h1>Create A Unit Work Order</h1>

		<div class="col-sm-12">
			<p><textarea cols="60" rows="5" name="workOrderText">blah blah blah address of building will go here: it is posted from the "create Workorder" form.</textarea></p>
		 </div>
